...
public class TelaCadastroCliente extends javax.swing.JFrame {
    ...
    public TelaCadastroCliente(Cliente cliente) throws ParseException {
        initComponents();
    ...
    private void preencherCampos() throws ParseException {
        txtNome.setText(clienteAlterar.getNomeCliente());
        txtEndereco.setText(clienteAlterar.getEndereco());
        jftxtCpf.setText(clienteAlterar.getCPF());
        jftxtFone.setText(clienteAlterar.getTelefone());
        txtEmail.setText(clienteAlterar.getEmail());
        lblID.setText(String.valueOf(clienteAlterar.getIdCliente()));

        if (clienteAlterar.getSexo().equalsIgnoreCase("masculino")) {
            rbMasculino.setSelected(true);
        } else {
            rbFeminino.setSelected(true);
        }

        jcbEstadoCivil.setSelectedItem(clienteAlterar.getEstadoCivil());

        SimpleDateFormat formatadorBanco = new SimpleDateFormat("yyyy-MM-dd");
        Date dataConvertida = formatadorBanco.parse(clienteAlterar.getDataNascimento());

        SimpleDateFormat formatadorExibicao = new SimpleDateFormat("dd/MM/yyyy");
        jftxtDataNascimento1.setText(formatadorExibicao.format(dataConvertida));
    }
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        String data = jftxtDataNascimento1.getText();
        ...
        if (txtNome.getText().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(rootPane, "O gênero deve ser identificado.");
            return;
        ...
        String dataFormatadaParaBanco = formatarDataParaMySQL(data);

        if (clienteAlterar == null) {
            Cliente a = new Cliente();
            a.setNomeCliente(txtNome.getText());
            a.setEndereco(txtEndereco.getText());
            a.setCPF(cpf);
            a.setTelefone(telefone);
            a.setEmail(txtEmail.getText());
            a.setSexo(sexo);
            a.setEstadoCivil((String) jcbEstadoCivil.getSelectedItem());
            a.setDataNascimento(dataFormatadaParaBanco);

            boolean retorno = ClienteDAO.salvar(a);
            ...
            clienteAlterar.setNomeCliente(txtNome.getText());
            clienteAlterar.setEndereco(txtEndereco.getText());
            ...
            clienteAlterar.setEstadoCivil((String) jcbEstadoCivil.getSelectedItem());
            clienteAlterar.setDataNascimento(dataFormatadaParaBanco);
